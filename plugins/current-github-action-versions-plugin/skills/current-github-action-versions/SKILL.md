...
aws-actions/configure-aws-credentials@v6 # role-to-assume, not access keys
azure/login@v3                           # OIDC federation, not SP secrets
```
